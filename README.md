...
- Added support for custom model selection in the sidebar
- Included options for GPT-4o and GPT-4o-mini models
- Implemented API key and base URL input fields in the sidebar
- Added a "Save API Settings" button to update environment variables
- Enhanced UI with improved styling and layout
- Included thinking time display for each reasoning step
- Added a total thinking time display at the end of the response

These updates provide more flexibility in model selection and API configuration, while also improving the user interface and adding performance metrics.
